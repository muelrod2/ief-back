...
describe('AppmonitoramentoController', () => {
  let controller: AppmonitoramentoController;
  let service: jest.Mocked<AppmonitoramentoService>;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      controllers: [AppmonitoramentoController],
      providers: [
        { provide: AppmonitoramentoService, useValue: mockService() },
      ],
    }).compile();

    controller = module.get<AppmonitoramentoController>(AppmonitoramentoController);
    service = module.get<AppmonitoramentoService>(AppmonitoramentoService) as jest.Mocked<AppmonitoramentoService>;
  });
